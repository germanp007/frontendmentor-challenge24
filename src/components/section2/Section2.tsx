...
const Section2 = () => {
  return (
    <section className="bg-LightGrayishBlue w-full min-h-[300px] py-1 pb-[105px] lg:flex lg:p-24">
      <div
        className="divImage w-full h-[400px] mx-auto mb-[7rem] order-2 md:h-[400px] bg-contain bg-no-repeat bg-center"
        // style={{
      ...
      {/* <img
        ...
        className="w-[90%] h-auto mx-auto mb-[7rem] max-w-[450px] order-2 md:h-[400px]"
      /> */}
      <div>
        <div>
          ...
          <div className="w-[174px] mx-auto mb-[60px] border-b-[1px] border-ModerateCyan lg:mx-0">
        ...
        <div className="card bg-white w-[90%] h-[217px] m-auto px-2 py-8 rounded-[5px] sm:max-w-[356px] lg:mx-0">
          ...
          <div className="text-VeryDarkBlue flex gap-2 w-[90%] m-auto">
            ...
            <div>
              ...
              <h3 className="text-[.55rem] font-light">
                Founder & CEO, Huddle
              </h3>
            </div>
          </div>
